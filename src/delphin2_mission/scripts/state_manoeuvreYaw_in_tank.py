...
class manoeuvreYaw(smach.State):
    def __init__(self, lib, myUti, timeDemandHold, timeDelay, depthDemand, depthTol, depthDemandMin, controlRate):
        ...
        self.__thrusterDemand = 700, 1400, 2100 # [100, 200, 400, 700, 1400, 2100] # list of thruster demand used in experiment
