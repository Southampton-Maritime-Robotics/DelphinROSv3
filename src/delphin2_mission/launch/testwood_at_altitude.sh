...
rosparam set mission/PathName "to_start_A"    # to_start_A, to_start_Areverse, path_A
timestamp="_$(date +%Y-%m-%d_%H:%M:%S)"
...
############################################################### New Mission
rosparam set mission/DiveHeading 220.
rosparam set mission/PathName "to_start_Areverse"    # to_start_A, to_start_Areverse, path_A
timestamp="_$(date +%Y-%m-%d_%H:%M:%S)"
