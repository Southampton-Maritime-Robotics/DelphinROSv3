...
class location(object):
    # packed binary data, e.g. using the pack function from the struct library
    # struct.pack('!3d', 50.937314, -1.404341, 0))
    info = {## Boldrewood campus: 50.937314, -1.404341, 0
            ...
            'Eastleight_Lake': (  0x40, 0x49, 0x7A, 0x83, 0x23, 0x35, 0x8F, 0x2E,
                                  ...
                                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
            ## Testwood Lake: 50.9364718, -1.5073961, 0
            'Testwood_Lake':     (0x40, 0x49, 0x77, 0xDE, 0x4E, 0xD5, 0x50, 0x29, 
                                  0xBF, 0xF8, 0x1E, 0x4b, 0x5F, 0x79, 0x3E, 0x1B, 
                                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)}
