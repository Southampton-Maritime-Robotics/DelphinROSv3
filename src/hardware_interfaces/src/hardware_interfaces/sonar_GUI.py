...
class Settings(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.timer.timeout.connect(self.settings_pub)
        self.timer.start(1000)
    
        self.show()

    def settings_pub(self):
        """
    ...
    def UpdateText(self, setting):
        ...
        text = (text + "Enter new value between " + str(self.limits[setting + 'Min']) +
               " and " + str(self.limits[setting + 'Max']))
        return text
